...
public final class UsuarioUtil {
    ...
    static public int getUniqueUsuarioId(final Connection conn)
        ...
        sbSelect.append(UsuarioDAOConstantes.USUARIO_ID_SEQUENCE_NAME.toUpperCase());
        sbSelect.append("'");
        try {
    ...
    static public void setupUsuarioTable() throws SQLException {
        ...
        try {
            ...
            sbDropTable.append(UsuarioDAOConstantes.USUARIO_TABLE_NAME);
            ...
            sbDropSeq.append(UsuarioDAOConstantes.USUARIO_ID_SEQUENCE_NAME);
            ...
            sbCreateSeq.append(UsuarioDAOConstantes.USUARIO_ID_SEQUENCE_NAME);
            ...
            sbCreateTable.append(UsuarioDAOConstantes.USUARIO_TABLE_NAME);
    ...
    static public Connection getConnection() {
        ...
        DataSource ds = null;
        try {
            Class.forName(UsuarioDAOConstantes.DRIVER).newInstance();

            conn = DriverManager.getConnection(UsuarioDAOConstantes.URL,
                    UsuarioDAOConstantes.USER,
                    UsuarioDAOConstantes.PASSWORD);
